"""
Django settings for floral_sound_41830 project.
...
ROOT_URLCONF = 'floral_sound_41830.urls'
...
WSGI_APPLICATION = 'floral_sound_41830.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "floral_sound_41830 API",
    "DESCRIPTION": "API documentation for floral_sound_41830 App",
    "VERSION": "v1",
}
